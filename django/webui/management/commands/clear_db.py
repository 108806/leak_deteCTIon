...
class Command(BaseCommand):
    help = (
        "Clear the database of all data from BreachedCredential and ScrapFile models."
    )
    ...
    def handle(self, *args, **kwargs):
        ...
        self.stdout.write(
            self.style.WARNING(
                f"✅ Deleted {breached_count} records from BreachedCredential."
            )
        )
        ...
        self.stdout.write(
            self.style.WARNING(f"✅ Deleted {scrap_count} records from ScrapFile.")
        )
